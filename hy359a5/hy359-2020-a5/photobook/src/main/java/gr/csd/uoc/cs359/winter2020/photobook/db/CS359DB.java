...
public class CS359DB {
    ...
    private static final String UNAME = "csd3524"; // Share your repo to give you the credentials
    private static final String PASSWD = "U@7+4ysb";  // Share your repo to give you the credentials
