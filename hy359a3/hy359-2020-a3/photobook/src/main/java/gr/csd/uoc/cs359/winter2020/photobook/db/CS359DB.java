...
public class CS359DB {
    ...
    private static final String UNAME = "csd3479"; // Share your repo to give you the credentials
    private static final String PASSWD = "j?D6525J";  // Share your repo to give you the credentials
